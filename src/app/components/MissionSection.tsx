  ...
  return (
    <section className="px-6 md:px-10 py-24 bg-background">
      <div className="max-w-7xl mx-auto">
        <div className="bg-dark-bg text-white rounded-3xl px-8 md:px-14 py-14 md:py-20 shadow-2xl max-w-5xl">
          <div className="flex items-center gap-4 mb-10">
            <p className="text-sm font-bold">About</p>
            <span className="w-16 h-px bg-white/80" />
          </div>

          <h2 className="text-3xl md:text-5xl font-bold leading-tight tracking-tight max-w-4xl mb-6">
